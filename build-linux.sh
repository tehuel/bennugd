...
case $1 in
    release)
        ./configure --build=i686-pc-linux-gnu PKG_CONFIG_PATH=${PKG_CONFIG_PATH} PKG_CONFIG_LIBDIR=${PKG_CONFIG_PATH} SDL_CFLAGS="-I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT" SDL_LIBS="-L/usr/lib/${TARGET} -lSDL" && make clean && make
        ;;
